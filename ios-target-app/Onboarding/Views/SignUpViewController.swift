...
class SignUpViewController: UIViewController {
  ...
  @objc func formEditingChange(_ sender: UITextField) {
    ...
    switch sender {
    case nameField:
      viewModel.fieldChanged(field: .name, value: newValue)
    case emailField:
      viewModel.fieldChanged(field: .email, value: newValue)
    case passwordField:
      viewModel.fieldChanged(field: .password, value: newValue)
    case confirmPasswordField:
      viewModel.fieldChanged(field: .passwordConfirmation, value: newValue)
    case genderTextfield:
      viewModel.fieldChanged(field: .gender, value: newValue)
    default: break
    }
  }
